...
![Fixed Size Window k=3](./images/fixed-size-window-k3.png)


### Variable Size Window (Minimum Length with Sum ≥ 7)

![Variable Size Window (Minimum Length with Sum ≥ 7)](./images/variable-size-window-minimum-length-with-sum-7.png)


![Variable Size Window](./images/variable-size-window.png)
...
![🎭 Pattern Overview](./images/pattern-overview.png)


![Sliding Window Patterns Overview](./images/sliding-window-patterns-overview.png)
