...
![Example Linked List with Cycle](./images/example-linked-list-with-cycle.png)

### List A: 1 → 2 ↘
![List A: 1 → 2 ↘](./images/list-a-1-2.png)

### Step 1: Create gap of n nodes
![Step 1: Create gap of n nodes](./images/step-1-create-gap-of-n-nodes.png)

### Node Structure & Memory Layout
![Node Structure & Memory Layout](./images/1-node-structure-memory-layout.png)
...
$$\boxed{S(n) = n \times (\text{data size} + \text{pointer size})}$$
...
$$\boxed{\text{slow position} = \left\lfloor \frac{n}{2} \right\rfloor}$$
