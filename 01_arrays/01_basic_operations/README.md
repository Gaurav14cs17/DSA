...
![Two Pointers: write (i) and read (j)](./images/two-pointers-write-i-and-read-j.png)

### Step 1: Reverse entire array
![Step 1: Reverse entire array](./images/step-1-reverse-entire-array.png)

### Three pointers: low, mid, high
![Three pointers: low, mid, high](./images/three-pointers-low-mid-high.png)
