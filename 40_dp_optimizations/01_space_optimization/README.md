...
nav_order: 1
permalink: /40_dp_optimizations/01_space_optimization/
---
...
| | |
|:---|:---|
| **In one line** | Rolling arrays — O(n²) → O(n) memory |
...
|:------------|:----------:|--------:|
| [🏠 DP Optimizations](../README.md) | **01. Space Optimization** | [Monotonic Queue →](../02_monotonic_queue/README.md) |
