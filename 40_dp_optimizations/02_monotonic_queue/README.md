...
nav_order: 2
permalink: /40_dp_optimizations/02_monotonic_queue/
---
...
![Monotonic Queue Walkthrough](./images/monotonic-queue-walkthrough.png)
...
| | |
|:---|:---|
| **In one line** | Sliding window DP — O(nk) → O(n) |
...
|:------------|:----------:|--------:|
| [← Space Optimization](../01_space_optimization/README.md) | **02. Monotonic Queue** | [Convex Hull Trick →](../03_convex_hull_trick/README.md) |
