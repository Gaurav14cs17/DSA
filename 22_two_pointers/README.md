...
![Opposite Direction Two Sum](./images/opposite-direction-two-sum.png)
...
![Same Direction Remove Duplicates](./images/same-direction-duplicates.png)
...
![Pattern 3: Floyd's Cycle Detection](./images/pattern-3-floyds-cycle-detection.png)
...
![Two Pointers Patterns Overview](./images/two-pointers-patterns-overview.png)
