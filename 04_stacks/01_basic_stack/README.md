...
![Array-Based Stack Implementation](./images/array-based-stack-implementation.png)

### Sequence: push(3), push(5), push(2), push(1), push(4)
![Sequence: push(3), push(5), push(2), push(1), push(4)](./images/sequence-push3-push5-push2-push1-push4.png)

### Operations: enqueue(1), enqueue(2), enqueue(3), dequeue()
![Operations: enqueue(1), enqueue(2), enqueue(3), dequeue()](./images/operations-enqueue1-enqueue2-enqueue3-dequeue.png)
