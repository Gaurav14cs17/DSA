...
{: .highlight }
> **How to use this page:** Scan **What You'll Master**, work through theory → visuals → code.
...
![Two Unique Numbers — Step by Step](./images/two-unique-numbers-step-by-step.png)
...
![XOR Prefix Sum Visualization](./images/xor-prefix-sum-visualization.png)
...
![XOR Properties](./images/xor-properties.png)
