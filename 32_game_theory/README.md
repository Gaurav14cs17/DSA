...
![Nim Game Decision Tree](./images/nim-decision-tree-pattern.png)
...
![Grundy Numbers](./images/grundy-numbers-pattern.png)
...
| | |
|:---|:---|
| **In one line** | Optimal Play, Strategy, and Winning Positions |
